...
require (
	github.com/datatrails/go-datatrails-common v0.16.0
...
require (
	...
	github.com/datatrails/go-datatrails-common-api-gen v0.4.5 // indirect
	github.com/datatrails/go-datatrails-merklelog/massifs v0.0.1 // indirect
